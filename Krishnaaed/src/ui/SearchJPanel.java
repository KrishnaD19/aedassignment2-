...
populateTable();
    ...
    private void initComponents() {
        ...
        SearchJpanel.setBackground(new java.awt.Color(255, 255, 153));
        ...
        cbSearch.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Questions.", "Find me the first available passenger car.", "List all the car manufacturers used by the Uber." }));
        ...
        cbIsAvailable.setText("Is Available");
        ...
        cbSearchCertificateExpired.setText("Is Certificate valid");

        lblManufacturedBy.setText("Manufactured company:");

        jLabel1.setText("Manufactured Date:");
                            ...
                            .addGroup(SearchJpanelLayout.createSequentialGroup()
                                .addGroup(SearchJpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(SearchJpanelLayout.createSequentialGroup()
                                        .addGroup(SearchJpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addComponent(lblSeats, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                                ...
                                .addGroup(SearchJpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(SearchJpanelLayout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addGroup(SearchJpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txtSearchGeolocation)
                                            .addComponent(txtSearchSerialNumber)
                                            .addComponent(txtSearchModelNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(SearchJpanelLayout.createSequentialGroup()
                                        .addGap(10, 10, 10)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(SearchJpanel, javax.swing.GroupLayout.PREFERRED_SIZE, 513, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
...
else if(selectedValue.equals("List all the car manufacturers used by the Uber."))
{
   ...
   System.out.println(lowSeats);
        ...
        if(mfBy.length()==0 || car.getManufactured_by().equals(mfBy) ){
            ...
            if(GeoLocation.length()==0 || car.getGeolocation().equals(GeoLocation)){
            ...
            if(availablity==false || car.isIsAvailable()==availablity){
            if(certification==false || car.getIs_maintanance_certificate_expired()==certification){
        row[1]=car.getManufactured_by();
        row[2]=car.getManufactured_year();
        row[3]=car.getSerial_number();
        row[4]=car.getModel_number();
